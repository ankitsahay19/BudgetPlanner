...
namespace BpstEdu.Migrations
{
    ...
    [Migration("20260215033636_upatedApplication")]
    partial class upatedApplication
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BpstEdu.DBModels.AppUser", b =>
                {
            ...
            modelBuilder.Entity("BpstEdu.DBModels.City", b =>
                {
                    b.Property<int>("UniqueId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BpstEdu.DBModels.Country", b =>
                {
                    b.Property<int>("UniqueId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BpstEdu.Models.ApplicationStatus", b =>
                {
                    b.Property<int>("UniqueId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BpstEdu.DBModels.City", b =>
                {
                    b.HasOne("BpstEdu.DBModels.State", "State")
                        .WithMany()
            ...
            modelBuilder.Entity("BpstEdu.DBModels.State", b =>
                {
                    b.HasOne("BpstEdu.DBModels.Country", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BpstEdu.DBModels.AppUser", null)
                        .WithMany()
