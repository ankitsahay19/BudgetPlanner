...
namespace BpstEdu.Migrations
{
    ...
    [Migration("20260215154425_ifMissing")]
    partial class ifMissing
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BpstEdu.DBModels.Application", b =>
                {
            ...
            modelBuilder.Entity("BpstEdu.DBModels.Batch", b =>
                {
                    b.Property<int>("UniqueId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BpstEdu.DBModels.Student.BatchStudent", b =>
                {
                    b.Property<int>("UniqueId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BpstEdu.DBModels.Student.Student", b =>
                {
                    b.Property<int>("UniqueId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BpstEdu.DBModels.Student.StudentFee", b =>
                {
                    b.Property<int>("UniqueId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BpstEdu.DBModels.User.AppUser", b =>
                {
            ...
            modelBuilder.Entity("BpstEdu.DBModels.User.City", b =>
                {
                    b.Property<int>("UniqueId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BpstEdu.DBModels.User.Country", b =>
                {
                    b.Property<int>("UniqueId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BpstEdu.DBModels.User.State", b =>
                {
                    b.Property<int>("UniqueId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BpstEdu.DBModels.Batch", b =>
                {
                    b.HasOne("BpstEdu.DBModels.Course", "Course")
                        .WithMany()
            ...
            modelBuilder.Entity("BpstEdu.DBModels.Student.BatchStudent", b =>
                {
                    b.HasOne("BpstEdu.DBModels.Batch", "Batch")
                        .WithMany()
                        .HasForeignKey("BatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BpstEdu.DBModels.Student.Student", "Student")
                        .WithMany()
            ...
            modelBuilder.Entity("BpstEdu.DBModels.Student.Student", b =>
                {
                    b.HasOne("BpstEdu.DBModels.Application", "Application")
                        .WithMany()
            ...
            modelBuilder.Entity("BpstEdu.DBModels.Student.StudentFee", b =>
                {
                    b.HasOne("BpstEdu.DBModels.Student.BatchStudent", null)
            ...
            modelBuilder.Entity("BpstEdu.DBModels.User.City", b =>
                {
                    b.HasOne("BpstEdu.DBModels.User.State", "State")
                        .WithMany()
            ...
            modelBuilder.Entity("BpstEdu.DBModels.User.State", b =>
                {
                    b.HasOne("BpstEdu.DBModels.User.Country", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BpstEdu.DBModels.User.AppUser", null)
                        .WithMany()
